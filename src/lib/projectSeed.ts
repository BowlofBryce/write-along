    ...
    memories: [
      {
        id: 'memory-key',
        projectId: 'seed',
        content: 'The silver key appears repeatedly and likely signals unresolved significance.',
        explicitness: 'inferred',
        sources: [{ nodeId: 'chapter-1', quote: 'The silver key was colder than stone...', capturedAt: new Date().toISOString() }],
        userNotes: '',
        linkedEntityIds: ['mara'],
        linkedMemoryIds: [],
        contradictionIds: [],
        importance: 0.91,
        durability: 0.8,
